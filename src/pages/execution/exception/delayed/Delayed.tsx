          ...
          <div className='flex flex-wrap items-center justify-between px-1 gap-y-4 bg-white/50 py-2.5 rounded-2xl sticky top-0 z-20 backdrop-blur-md shadow-sm border border-white'>
            ...
            <div className='flex items-center gap-2 mr-2'>
              ...
              <Button
                type='primary'
                icon={<Bot size={16} />}
                className='rounded-xl bg-slate-800 shadow-md shadow-slate-300 font-bold border-none h-10 flex items-center justify-center hover:bg-slate-700 px-4'
